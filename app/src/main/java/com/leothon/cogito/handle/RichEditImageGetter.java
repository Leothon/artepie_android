package com.leothon.cogito.handle;
...
public class RichEditImageGetter implements Html.ImageGetter {
    ...
    private final RichEditTextView mTextView;
    public RichEditImageGetter(Context context, RichEditTextView textView) {
    ...
    class BitmapTarget extends SimpleTarget<Bitmap> {
        ...
        public void onResourceReady(@NonNull Bitmap resource, @Nullable Transition<? super Bitmap> transition) {
            ...
            int padding = CommonUtils.dip2px(mContext,30);
