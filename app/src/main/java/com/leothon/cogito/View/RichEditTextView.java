...
import com.leothon.cogito.Utils.ImagePlate;
import com.leothon.cogito.Utils.SpanPart;

import java.util.ArrayList;
import java.util.List;

public class RichEditTextView extends AppCompatEditText implements View.OnClickListener {
