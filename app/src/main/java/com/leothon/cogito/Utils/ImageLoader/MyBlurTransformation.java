...
public class MyBlurTransformation extends CenterCrop {
    ...
    public MyBlurTransformation(int radius,Context context) {
        this(radius, DEFAULT_DOWN_SAMPLING,context);
    }

    public MyBlurTransformation(int radius, int sampling,Context context) {
        this.radius = radius;
