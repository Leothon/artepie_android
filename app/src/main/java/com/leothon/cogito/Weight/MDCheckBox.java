...
public class MDCheckBox extends View implements Checkable{
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.MDCheckBox);
        size = ta.getDimensionPixelSize(R.styleable.MDCheckBox_size, dp(size));
        bitmapColor = ta.getColor(R.styleable.MDCheckBox_color_background, bitmapColor);
        borderColor = ta.getColor(R.styleable.MDCheckBox_color_border, borderColor);
        ...
        checkDrawable = context.getResources().getDrawable(R.drawable.baseline_done_white_24);
