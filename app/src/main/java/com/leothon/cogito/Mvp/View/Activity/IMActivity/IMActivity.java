package com.leothon.cogito.Mvp.View.Activity.IMActivity;
...
import com.leothon.cogito.View.ChatView;
...
public class IMActivity extends BaseActivity implements ChatView.OnKeyboardChangedListener,
            ...
            if (userInfo == null) {
                JMessageClient.getUserInfo(mTargetId, new GetUserInfoCallback() {
                    ...
                    public void gotResult(int status, String s, UserInfo userInfo) {
                        if (status == 0) {
//                            mChatView.setTitle(userInfo.getNickname());
                            setToolbarTitle(userInfo.getNickname());
                        }
                    }
                });
            } else {
...
//                        message = new JMUIMessage(null, IMessage.MessageType.SEND_VIDEO);
                ...
                public void switchToMicrophoneMode() {
                    if ((ActivityCompat.checkSelfPermission(IMActivity.this,
                        ...
                        ActivityCompat.requestPermissions(IMActivity.this, new String[]{
